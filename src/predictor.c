...
//
const char *studentName = "ZHAOKAI XU";
const char *studentID   = "A14738474";
const char *email       = "zhx121@eng.ucsd.edu";
...
//
// This will be run before any predictions are made. 
// This is where you will initialize any data structures or values you need for a particular branch predictor 'bpType'. 
// All switches will be set prior to this function being called.
void init_predictor()
{
    switch (bpType) {
        case STATIC:
...
//
// You will be given the PC of a branch and are required to make a prediction of TAKEN or NOTTAKEN which will then be checked back in the main execution loop. 
// You may want to break up the implementation of each type of branch predictor into separate functions to improve readability.
